...
if(isset($_POST['submit'])){
    ...
    $sql=mysqli_query($conn,"UPDATE import SET p_id='$pid',quantity='$qnty',created_by='$created_by' WHERE imp_id='$_GET[upd]' ");
    if($sql){
